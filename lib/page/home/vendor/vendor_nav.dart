...
class BottomNavVendor extends StatelessWidget {
  const BottomNavVendor({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<NavControllerD1>(
      init: NavControllerD1(),
...
class NavControllerD1 extends GetxController {
  int selectedIndex = 0;
  bool isVisible = true;
